    ...
    <Overlay
      ...
      <View>
        <View style={styles.titleContainer}>
          <AppText style={styles.title}>Job Offer</AppText>
        </View>
        <View style={styles.container}>
          <Image source={images.offer} style={styles.icon} />
          <AppText body1 style={styles.textAlign}>
            You nailed the interview! Do you want to take the offer as{' '}
            <AppText style={{fontWeight: 'bold'}}>{job.title}</AppText> at{' '}
            <AppText style={{fontWeight: 'bold'}}>{job.company}</AppText>?
          </AppText>
          <AppText body1 style={styles.textAlign}>
            [You will leave your current job if you have one]
          </AppText>
        </View>
