  ...
  return (
    <View>
      <View
        ...
        <TouchableOpacity onPress={() => onPress(1)} style={styles.routeContainer}>
          <Image
        ...
        <TouchableOpacity onPress={() => onPress(2)} style={styles.routeContainer}>
          <Image
        ...
        <TouchableOpacity
          ...
          style={[styles.routeContainer, styles.lastRouteRadius]}>
          <Image
            style={isFocused(4) ? styles.selectedIcon : styles.icon}
